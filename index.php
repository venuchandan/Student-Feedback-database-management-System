  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="php/feedback.php" method="post" class="student-form">
        ...
        <input type="text" id="regNumber" name="regNumber" placeholder="Enter Register/USN Number" />
          <br />
          ...
          <select name="branch" id="branch">
            ...
            <option value="AD&DS">AI&DS</option>
          ...
          <select name="subject" id="subject">
            ...
            <option value="AMS">Applied Mathematics and Statics</option>
            <option value="ML">Machine Learning</option>
            <option value="ATC">Automata Theory and Compiler Design </option>
